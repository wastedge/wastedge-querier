...
namespace WastedgeQuerier.Support
{
    ...
    class OleDropData : System.Windows.Forms.IDataObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OleDropData"/> class.
        /// </summary>
        ...
        public object GetData(string format, bool autoConvert)
        {
            ...
            switch (format)
            {
                ...
                case "FileContents":
                    ...
                    string[] fileContentNames;
                    if (GetDataPresent("FileGroupDescriptorW"))
                        fileContentNames = (string[])GetData("FileGroupDescriptorW");
                    else if (GetDataPresent("FileGroupDescriptor"))
                        fileContentNames = (string[])GetData("FileGroupDescriptor");
                    else
                        fileContentNames = new string[0];
        ...
        /// <summary>
        /// Get a list of all formats that data stored in this instance is associated with or can be converted to, using a Boolean value to determine whether to retrieve all formats that the data can be converted to or only native data formats.
        /// </summary>
